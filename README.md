...
Initial idea: Niko. Code: Niko (me) and Matthijs ([his website](https://mlwild.net)). Code based on [Periodic System of Elements interactive plot](https://docs.bokeh.org/en/latest/docs/gallery/periodic.html). 
